...
x_test_new_list =  np.array(x_test_new_list)
x_test_new_list = x_test_new_list * movie_indices
x_test_reconstructed = vae.predict([x_test_new_list, x_test], batch_size=batch_size)
