...
vae.fit_generator(nn_batch_generator(), samples_per_epoch=x_train.shape[0], nb_epoch=nb_epochs, callbacks=[checkpointer, reduce_lr], validation_data=(x_val, x_val))